    ...
    <div className="main-bg5">
      <div className="container">
        <ul>
          {activeTab === 0 && (
            <li>
              <img src="/trickacl-home/img/5page/media-paper-bg.png"></img>
                ...
                {Array.from({ length: 15 }).map((_, idx) => {
                  ...
                  return (
                    <li>
                      ...
                      >
                        <img src="/trickacl-home/img/5page/media-paper-btn.png"></img>
                      </a>
                    </li>
                  );
                })}
          ...
          {activeTab === 1 && (
            <li>
              <img src="/trickacl-home/img/5page/media-merch-bg.png"></img>
        ...
        <img src="/trickacl-home/img/5page/media-text.png"></img>
      </div>
    </div>
  );
}
