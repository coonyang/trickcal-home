  ...
  return (
    <>
      ...
      <button className="mainBtn" onClick={openMenu}>
        <img
          src="/trickacl-home/img/nav-button.png"
          alt="버튼이미지"
      ...
      <div className="Btns">
        ...
        >
          <img src="/trickacl-home/img/nav-sns01.png" alt="youtube"></img>
        </a>
        <a
          className="nav-sns"
          ...
          rel="noopener noreferrer"
        >
          <img src="/trickacl-home/img/nav-sns02.png" alt="youtube"></img>
        </a>
        <a
          className="nav-sns"
          ...
          rel="noopener noreferrer"
        >
          <img src="/trickacl-home/img/nav-sns03.png" alt="youtube"></img>
        </a>
        <a
          className="nav-sns"
          ...
          rel="noopener noreferrer"
        >
          <img src="/trickacl-home/img/nav-sns04.png" alt="youtube"></img>
        </a>
      </div>
      ...
      >
        <button className="closeBtn" onClick={closeMenu}>
          <img
            src="/trickacl-home/img/nav-close.png"
            style={{ width: "60px", height: "60px", display: "block" }}
          ></img>
        </button>
        <a
